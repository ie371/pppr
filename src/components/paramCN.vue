        ...
        <div class="form-group">
          ...
          <div class="form-row mb-2">
            ...
            <div class="col">
              ...
              >
                <option
                  v-for="(option, index) in this.dipIM4.dui4"
                  v-bind:value="option.value"
                  :key="index"
                >{{ option.text }}</option>
              </select>
          ...
          <b-row>
            <div class="col-md-12">
              ...
              <b-modal
                ref="myModalRef"
                hide-footer
                title="Принципиальная схема узла учета"
                size="lg"
              >
...
export default {
  ...
  methods: {
    proj(m, u) {
      ...
      switch (m) {
          ...
          this.isx.qmax > 0
            ? ((this.pr_gvs = 1),
              this.isx.sx_otkr > 0 || this.isx.sx_gvs_dep > 0
                ? (tip_rascheta = "og")
                : (tip_rascheta = "g"))
            : ((this.pr_gvs = 0), (tip_rascheta = this.tipProject));
        ...
        case "qgvssr":
          ...
          this.isx.qgvssr > 0 ? (this.pr_gvs = 1) : (this.pr_gvs = 0);
          this.isx.tipLg3 == "ml"
            ? ((this.fg = true), (this.isx.filg = 0))
            : (this.fg = false);
          this.isx.qgvssr > 0
    ...
    savePDF(nPDF) {
      ...
      let formData = new FormData(formTS);
    ...
    //   // request.open("POST", "./pdf/project/pr.php");
    //   // request.send(formData);
    //   var form = document.forms.namedItem("formTS");
