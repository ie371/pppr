    ...
    <div class="col-md-3 px-3 border-left border-warning">
      ...
      <div class="d-flex justify-content-center">
        <div class="col-md-9">
          ...
          <ul id="example-1">
            <li v-for="(item, index) in pozOt.arNPOZgvs" :key="index">поз. - {{ item }} - {{index}}</li>
          </ul>-->
          <!--                                     
                                </div>
